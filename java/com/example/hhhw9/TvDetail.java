...
public class TvDetail extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        facebook.setOnClickListener(new View.OnClickListener(){
            @Override
            public void onClick(View v) {
                String share="https://www.themoviedb.org/tv/"+id.substring(1,id.length());
        ...
        twitter.setOnClickListener(new View.OnClickListener(){
            ...
            public void onClick(View v) {
                ...
                String shareText="https://www.themoviedb.org/tv/"+id.substring(1,id.length());
            ...
            public void onSuccess(ArrayList<SliderData> list){
                ...
                adapter.setOnItemClickListener(new MovieDetailAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(View view,int position) {
                        ...
                        intent.setClass(getApplicationContext(), TvDetail.class);
...
//        String url = "https://api.themoviedb.org/3/tv/"+id.substring(1,id.length())+"?api_key=38ed65c377771b36628b1df55ae458b9&language=en-US&page=1";
        String url="http://xueyuhw9.wl.r.appspot.com/detailtv/"+id.substring(1,id.length());
        JsonArrayRequest request = new JsonArrayRequest(Request.Method.GET, url, null, new Response.Listener<JSONArray>() {
            ...
            public void onResponse(JSONArray array) {
                try {
                    ...
                    String year=response.getString("first_air_date");
...
//        String videourl = "https://api.themoviedb.org/3/tv/"+id.substring(1,id.length())+"/videos?api_key=38ed65c377771b36628b1df55ae458b9&language=en-US&page=1";
        String videourl="http://xueyuhw9.wl.r.appspot.com/videostv/"+id.substring(1,id.length());
...
//        String url = "https://api.themoviedb.org/3/tv/"+id.substring(1,id.length())+"/credits?api_key=38ed65c377771b36628b1df55ae458b9&language=en-US&page=1";
        String url="http://xueyuhw9.wl.r.appspot.com/creditstv/"+id.substring(1,id.length());
...
//        String url = "https://api.themoviedb.org/3/tv/"+id.substring(1,id.length())+"/reviews?api_key=38ed65c377771b36628b1df55ae458b9&language=en-US&page=1";
        String url="http://xueyuhw9.wl.r.appspot.com/reviewstv/"+id.substring(1,id.length());
...
//        String url = "https://api.themoviedb.org/3/tv/"+id.substring(1,id.length())+"/recommendations?api_key=38ed65c377771b36628b1df55ae458b9&language=en-US&page=1";
        String url="http://xueyuhw9.wl.r.appspot.com/recommendationtv/"+id.substring(1,id.length());
...
//                    JSONArray recommendations=response.getJSONArray("results");
                    for(int i=0;i<10;i++){
                        ...
                        String title=recom.getString("name");
                        String poster="";
                        try {
                            String poster1=recom.getString("poster_path");
                            if(!poster1.equals("null")&&!poster1.equals(""))
