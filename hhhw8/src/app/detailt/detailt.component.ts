...
export class DetailtComponent implements OnInit ,OnDestroy{
  detail:any=[];
  credit:any=[];
  review:any=[];
  video:any=[];
  ...
  ngOnInit() {
    ...
    this.f8();
    this.f9();
    this.text=this.text+"Watch "+this.detail[0].name+"/n"+this.video[0].url+"/n"+"#USC #CSCI571 #FightOn";
  }
  f9(){
  ...
  f1(){
    var url='http://localhost:3000/detailtv/';
    url+=this.id;
  ...
  f2() {
    var url='http://localhost:3000/creditstv/';
    url+=this.id;
    this.dataService.sendGetRequest(url).subscribe(data=>{
      console.log(data);
      this.credit=data;
  ...
  f3() {
    var url='http://localhost:3000/reviewstv/';
    url+=this.id;
    this.dataService.sendGetRequest(url).subscribe(data=>{
      console.log(data);
      this.review=data;
  ...
  f4() {
    var url='http://localhost:3000/recommendationtv/';
    url+=this.id;
    this.dataService.sendGetRequest(url).subscribe(data=>{
      console.log(data);
  ...
  f5() {
    var url='http://localhost:3000/similartv/';
    url+=this.id;
    this.dataService.sendGetRequest(url).subscribe(data=>{
      console.log(data);
      this.similar=data;
  ...
  f6() {
    var url='http://localhost:3000/videostv/';
    url+=this.id;
    this.dataService.sendGetRequest(url).subscribe(data=>{
      console.log(data);
      this.video=data;
